all:
	...
	CGO_ENABLED=0            go build -v -trimpath -ldflags="-s -w"              github.com/dongbiao830415/flamegraph/cmd/memleak
debug:
	...
	CGO_ENABLED=0            go build -v -gcflags="all=-N -l" -o memleak   github.com/dongbiao830415/flamegraph/cmd/memleak
clean:
